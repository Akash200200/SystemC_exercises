...
private:
    ...
    void process()
    {
        ...
        // Question:
        //  - Does this action make any difference? Why?        -> [SIMON]: No, because the last write is applied only (methods execute "concurrently")
        ...
        // what is going on.
        // Questions:
        //  - How these writes to A and B affect Z?         -> [SIMON]: They take a cycle to show in Z following the nand logic implemented
        //  - Is the process triggered when Z changes?      -> [SIMON]: No, as it is in the sensitivity list
        //  - Are some of the writes to A and B ignored?    -> [SIMON]: Yes, only the last value is applied
